 ...
 * needed in ExpressionTree.java. It also has a
...
public abstract class ZTree {
     ...
     * parentheses. The parse method should be able to handle an arbitrary number
     * of white spaces in the expression. 
     ...
     * using the Shunting-yard algorithm from Edsger Dijkstra.
